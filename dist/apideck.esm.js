...
export { AddressFromJSON, AddressFromJSONTyped, AddressToJSON, AddressType, Apideck, BASE_PATH, BadRequestFromJSON, BadRequestFromJSONTyped, BadRequestToJSON, BankAccountFromJSON, BankAccountFromJSONTyped, BankAccountToJSON, BaseAPI, BlobApiResponse, COLLECTION_FORMATS, CompaniesApi, CompanyFromJSON, CompanyFromJSONTyped, CompanyToJSON, Configuration, ContactFromJSON, ContactFromJSONTyped, ContactGender, ContactToJSON, ContactsApi, CreateCompanyResponseFromJSON, CreateCompanyResponseFromJSONTyped, CreateCompanyResponseToJSON, CreateContactResponseFromJSON, CreateContactResponseFromJSONTyped, CreateContactResponseToJSON, CreateLeadResponseFromJSON, CreateLeadResponseFromJSONTyped, CreateLeadResponseToJSON, CreateOpportunityResponseFromJSON, CreateOpportunityResponseFromJSONTyped, CreateOpportunityResponseToJSON, CustomFieldFromJSON, CustomFieldFromJSONTyped, CustomFieldToJSON, DeleteCompanyResponseFromJSON, DeleteCompanyResponseFromJSONTyped, DeleteCompanyResponseToJSON, DeleteContactResponseFromJSON, DeleteContactResponseFromJSONTyped, DeleteContactResponseToJSON, DeleteLeadResponseFromJSON, DeleteLeadResponseFromJSONTyped, DeleteLeadResponseToJSON, DeleteOpportunityResponseFromJSON, DeleteOpportunityResponseFromJSONTyped, DeleteOpportunityResponseToJSON, EmailFromJSON, EmailFromJSONTyped, EmailToJSON, GetCompaniesResponseFromJSON, GetCompaniesResponseFromJSONTyped, GetCompaniesResponseToJSON, GetCompanyResponseFromJSON, GetCompanyResponseFromJSONTyped, GetCompanyResponseToJSON, GetContactResponseFromJSON, GetContactResponseFromJSONTyped, GetContactResponseToJSON, GetContactsResponseFromJSON, GetContactsResponseFromJSONTyped, GetContactsResponseToJSON, GetLeadResponseFromJSON, GetLeadResponseFromJSONTyped, GetLeadResponseToJSON, GetLeadsResponseFromJSON, GetLeadsResponseFromJSONTyped, GetLeadsResponseToJSON, GetOpportunitiesResponseFromJSON, GetOpportunitiesResponseFromJSONTyped, GetOpportunitiesResponseToJSON, GetOpportunityResponseFromJSON, GetOpportunityResponseFromJSONTyped, GetOpportunityResponseToJSON, JSONApiResponse, LeadFromJSON, LeadFromJSONTyped, LeadToJSON, LeadsApi, LinksFromJSON, LinksFromJSONTyped, LinksToJSON, MetaCursorsFromJSON, MetaCursorsFromJSONTyped, MetaCursorsToJSON, MetaFromJSON, MetaFromJSONTyped, MetaToJSON, NotFoundResponseFromJSON, NotFoundResponseFromJSONTyped, NotFoundResponseToJSON, NotImplementedFromJSON, NotImplementedFromJSONTyped, NotImplementedToJSON, OpportunitiesApi, OpportunityFromJSON, OpportunityFromJSONTyped, OpportunityToJSON, PaymentRequiredFromJSON, PaymentRequiredFromJSONTyped, PaymentRequiredToJSON, PhoneNumberFromJSON, PhoneNumberFromJSONTyped, PhoneNumberToJSON, PhoneNumberType, RequiredError, SocialLinkFromJSON, SocialLinkFromJSONTyped, SocialLinkToJSON, TextApiResponse, UnauthorizedFromJSON, UnauthorizedFromJSONTyped, UnauthorizedToJSON, UnexpectedErrorFromJSON, UnexpectedErrorFromJSONTyped, UnexpectedErrorToJSON, UnifiedIdFromJSON, UnifiedIdFromJSONTyped, UnifiedIdToJSON, UnprocessableFromJSON, UnprocessableFromJSONTyped, UnprocessableToJSON, UpdateCompanyResponseFromJSON, UpdateCompanyResponseFromJSONTyped, UpdateCompanyResponseToJSON, UpdateContactResponseFromJSON, UpdateContactResponseFromJSONTyped, UpdateContactResponseToJSON, UpdateLeadResponseFromJSON, UpdateLeadResponseFromJSONTyped, UpdateLeadResponseToJSON, UpdateOpportunityResponseFromJSON, UpdateOpportunityResponseFromJSONTyped, UpdateOpportunityResponseToJSON, VoidApiResponse, WebsiteFromJSON, WebsiteFromJSONTyped, WebsiteToJSON, canConsumeForm, exists, mapValues, querystring };
//# sourceMappingURL=apideck.esm.js.map
