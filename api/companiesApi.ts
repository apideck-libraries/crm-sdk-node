...
import { CompaniesAdd } from '../model/companiesAdd';
import { CompaniesAddResponse } from '../model/companiesAddResponse';
import { CompaniesDeleteResponse } from '../model/companiesDeleteResponse';
import { CompaniesUpdate } from '../model/companiesUpdate';
import { CompaniesUpdateResponse } from '../model/companiesUpdateResponse';
...
export class CompaniesApi {
     ...
     */
    public async companiesAdd (xApideckConsumerId: string, xApideckAppId: string, companiesAdd: CompaniesAdd, raw?: boolean, xApideckServiceId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CompaniesAddResponse;  }> {
        ...
        if (xApideckConsumerId === null || xApideckConsumerId === undefined) {
            throw new Error('Required parameter xApideckConsumerId was null or undefined when calling companiesAdd.');
        }

        // verify required parameter 'xApideckAppId' is not null or undefined
        if (xApideckAppId === null || xApideckAppId === undefined) {
            throw new Error('Required parameter xApideckAppId was null or undefined when calling companiesAdd.');
        }

        // verify required parameter 'companiesAdd' is not null or undefined
        if (companiesAdd === null || companiesAdd === undefined) {
            throw new Error('Required parameter companiesAdd was null or undefined when calling companiesAdd.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(companiesAdd, "CompaniesAdd")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: CompaniesAddResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "CompaniesAddResponse");
     ...
     */
    public async companiesAll (xApideckConsumerId: string, xApideckAppId: string, raw?: boolean, xApideckServiceId?: string, offset?: number, page?: number, perPage?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Companies;  }> {
        const localVarPath = this.basePath + '/companies';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'xApideckConsumerId' is not null or undefined
        if (xApideckConsumerId === null || xApideckConsumerId === undefined) {
            throw new Error('Required parameter xApideckConsumerId was null or undefined when calling companiesAll.');
        }

        // verify required parameter 'xApideckAppId' is not null or undefined
        if (xApideckAppId === null || xApideckAppId === undefined) {
            throw new Error('Required parameter xApideckAppId was null or undefined when calling companiesAll.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Companies;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "Companies");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param xApideckServiceId Provide the service id you want to call (e.g., pipedrive). See the full list in the connector section. Only needed when a consumer has activated multiple integrations for a Unified API.
     */
    public async companiesDelete (xApideckConsumerId: string, xApideckAppId: string, id: string, raw?: boolean, xApideckServiceId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CompaniesDeleteResponse;  }> {
        ...
        // verify required parameter 'xApideckConsumerId' is not null or undefined
        if (xApideckConsumerId === null || xApideckConsumerId === undefined) {
            throw new Error('Required parameter xApideckConsumerId was null or undefined when calling companiesDelete.');
        }

        // verify required parameter 'xApideckAppId' is not null or undefined
        if (xApideckAppId === null || xApideckAppId === undefined) {
            throw new Error('Required parameter xApideckAppId was null or undefined when calling companiesDelete.');
        }

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling companiesDelete.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: CompaniesDeleteResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "CompaniesDeleteResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param xApideckServiceId Provide the service id you want to call (e.g., pipedrive). See the full list in the connector section. Only needed when a consumer has activated multiple integrations for a Unified API.
     */
    public async companiesOne (xApideckConsumerId: string, xApideckAppId: string, id: string, raw?: boolean, xApideckServiceId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Company;  }> {
        const localVarPath = this.basePath + '/companies/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'xApideckConsumerId' is not null or undefined
        if (xApideckConsumerId === null || xApideckConsumerId === undefined) {
            throw new Error('Required parameter xApideckConsumerId was null or undefined when calling companiesOne.');
        }

        // verify required parameter 'xApideckAppId' is not null or undefined
        if (xApideckAppId === null || xApideckAppId === undefined) {
            throw new Error('Required parameter xApideckAppId was null or undefined when calling companiesOne.');
        }

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling companiesOne.');
        }
     ...
     * @param xApideckAppId The ID of your Unify application
     * @param id ID of the record you are acting upon.
     * @param companiesUpdate 
     * @param raw Include raw response. Mostly used for debugging purposes
     * @param xApideckServiceId Provide the service id you want to call (e.g., pipedrive). See the full list in the connector section. Only needed when a consumer has activated multiple integrations for a Unified API.
     */
    public async companiesUpdate (xApideckConsumerId: string, xApideckAppId: string, id: string, companiesUpdate: CompaniesUpdate, raw?: boolean, xApideckServiceId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: CompaniesUpdateResponse;  }> {
        const localVarPath = this.basePath + '/companies/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'xApideckConsumerId' is not null or undefined
        if (xApideckConsumerId === null || xApideckConsumerId === undefined) {
            throw new Error('Required parameter xApideckConsumerId was null or undefined when calling companiesUpdate.');
        }

        // verify required parameter 'xApideckAppId' is not null or undefined
        if (xApideckAppId === null || xApideckAppId === undefined) {
            throw new Error('Required parameter xApideckAppId was null or undefined when calling companiesUpdate.');
        }

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling companiesUpdate.');
        }

        // verify required parameter 'companiesUpdate' is not null or undefined
        if (companiesUpdate === null || companiesUpdate === undefined) {
            throw new Error('Required parameter companiesUpdate was null or undefined when calling companiesUpdate.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(companiesUpdate, "CompaniesUpdate")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: CompaniesUpdateResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "CompaniesUpdateResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
