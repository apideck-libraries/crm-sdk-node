...
import { ContactsAdd } from '../model/contactsAdd';
import { ContactsAddResponse } from '../model/contactsAddResponse';
import { ContactsDeleteResponse } from '../model/contactsDeleteResponse';
import { ContactsUpdate } from '../model/contactsUpdate';
import { ContactsUpdateResponse } from '../model/contactsUpdateResponse';
...
export class ContactsApi {
     ...
     */
    public async contactsAdd (xApideckConsumerId: string, xApideckAppId: string, contactsAdd: ContactsAdd, raw?: boolean, xApideckServiceId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ContactsAddResponse;  }> {
        ...
        if (xApideckConsumerId === null || xApideckConsumerId === undefined) {
            throw new Error('Required parameter xApideckConsumerId was null or undefined when calling contactsAdd.');
        }

        // verify required parameter 'xApideckAppId' is not null or undefined
        if (xApideckAppId === null || xApideckAppId === undefined) {
            throw new Error('Required parameter xApideckAppId was null or undefined when calling contactsAdd.');
        }

        // verify required parameter 'contactsAdd' is not null or undefined
        if (contactsAdd === null || contactsAdd === undefined) {
            throw new Error('Required parameter contactsAdd was null or undefined when calling contactsAdd.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(contactsAdd, "ContactsAdd")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ContactsAddResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ContactsAddResponse");
     ...
     */
    public async contactsAll (xApideckConsumerId: string, xApideckAppId: string, raw?: boolean, xApideckServiceId?: string, offset?: number, page?: number, perPage?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Contacts;  }> {
        const localVarPath = this.basePath + '/contacts';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'xApideckConsumerId' is not null or undefined
        if (xApideckConsumerId === null || xApideckConsumerId === undefined) {
            throw new Error('Required parameter xApideckConsumerId was null or undefined when calling contactsAll.');
        }

        // verify required parameter 'xApideckAppId' is not null or undefined
        if (xApideckAppId === null || xApideckAppId === undefined) {
            throw new Error('Required parameter xApideckAppId was null or undefined when calling contactsAll.');
        }
     ...
     * @param xApideckServiceId Provide the service id you want to call (e.g., pipedrive). See the full list in the connector section. Only needed when a consumer has activated multiple integrations for a Unified API.
     */
    public async contactsDelete (xApideckConsumerId: string, xApideckAppId: string, id: string, raw?: boolean, xApideckServiceId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ContactsDeleteResponse;  }> {
        ...
        // verify required parameter 'xApideckConsumerId' is not null or undefined
        if (xApideckConsumerId === null || xApideckConsumerId === undefined) {
            throw new Error('Required parameter xApideckConsumerId was null or undefined when calling contactsDelete.');
        }

        // verify required parameter 'xApideckAppId' is not null or undefined
        if (xApideckAppId === null || xApideckAppId === undefined) {
            throw new Error('Required parameter xApideckAppId was null or undefined when calling contactsDelete.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ContactsDeleteResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ContactsDeleteResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param xApideckServiceId Provide the service id you want to call (e.g., pipedrive). See the full list in the connector section. Only needed when a consumer has activated multiple integrations for a Unified API.
     */
    public async contactsOne (xApideckConsumerId: string, xApideckAppId: string, id: string, raw?: boolean, xApideckServiceId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Contact;  }> {
        const localVarPath = this.basePath + '/contacts/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'xApideckConsumerId' is not null or undefined
        if (xApideckConsumerId === null || xApideckConsumerId === undefined) {
            throw new Error('Required parameter xApideckConsumerId was null or undefined when calling contactsOne.');
        }

        // verify required parameter 'xApideckAppId' is not null or undefined
        if (xApideckAppId === null || xApideckAppId === undefined) {
            throw new Error('Required parameter xApideckAppId was null or undefined when calling contactsOne.');
        }

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling contactsOne.');
        }
     ...
     * @param xApideckAppId The ID of your Unify application
     * @param id ID of the record you are acting upon.
     * @param contactsUpdate 
     * @param raw Include raw response. Mostly used for debugging purposes
     * @param xApideckServiceId Provide the service id you want to call (e.g., pipedrive). See the full list in the connector section. Only needed when a consumer has activated multiple integrations for a Unified API.
     */
    public async contactsUpdate (xApideckConsumerId: string, xApideckAppId: string, id: string, contactsUpdate: ContactsUpdate, raw?: boolean, xApideckServiceId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: ContactsUpdateResponse;  }> {
        const localVarPath = this.basePath + '/contacts/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'xApideckConsumerId' is not null or undefined
        if (xApideckConsumerId === null || xApideckConsumerId === undefined) {
            throw new Error('Required parameter xApideckConsumerId was null or undefined when calling contactsUpdate.');
        }

        // verify required parameter 'xApideckAppId' is not null or undefined
        if (xApideckAppId === null || xApideckAppId === undefined) {
            throw new Error('Required parameter xApideckAppId was null or undefined when calling contactsUpdate.');
        }

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling contactsUpdate.');
        }

        // verify required parameter 'contactsUpdate' is not null or undefined
        if (contactsUpdate === null || contactsUpdate === undefined) {
            throw new Error('Required parameter contactsUpdate was null or undefined when calling contactsUpdate.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(contactsUpdate, "ContactsUpdate")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: ContactsUpdateResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "ContactsUpdateResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
