...
import { LeadsAdd } from '../model/leadsAdd';
import { LeadsAddResponse } from '../model/leadsAddResponse';
import { LeadsDeleteResponse } from '../model/leadsDeleteResponse';
import { LeadsUpdate } from '../model/leadsUpdate';
import { LeadsUpdateResponse } from '../model/leadsUpdateResponse';
...
export class LeadsApi {
     ...
     */
    public async leadsAdd (xApideckConsumerId: string, xApideckAppId: string, leadsAdd: LeadsAdd, raw?: boolean, xApideckServiceId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: LeadsAddResponse;  }> {
        ...
        if (xApideckConsumerId === null || xApideckConsumerId === undefined) {
            throw new Error('Required parameter xApideckConsumerId was null or undefined when calling leadsAdd.');
        }

        // verify required parameter 'xApideckAppId' is not null or undefined
        if (xApideckAppId === null || xApideckAppId === undefined) {
            throw new Error('Required parameter xApideckAppId was null or undefined when calling leadsAdd.');
        }

        // verify required parameter 'leadsAdd' is not null or undefined
        if (leadsAdd === null || leadsAdd === undefined) {
            throw new Error('Required parameter leadsAdd was null or undefined when calling leadsAdd.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            json: true,
            body: ObjectSerializer.serialize(leadsAdd, "LeadsAdd")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: LeadsAddResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "LeadsAddResponse");
     ...
     */
    public async leadsAll (xApideckConsumerId: string, xApideckAppId: string, raw?: boolean, xApideckServiceId?: string, offset?: number, page?: number, perPage?: number, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Leads;  }> {
        const localVarPath = this.basePath + '/leads';
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        const produces = ['application/json'];
        ...
        // verify required parameter 'xApideckConsumerId' is not null or undefined
        if (xApideckConsumerId === null || xApideckConsumerId === undefined) {
            throw new Error('Required parameter xApideckConsumerId was null or undefined when calling leadsAll.');
        }

        // verify required parameter 'xApideckAppId' is not null or undefined
        if (xApideckAppId === null || xApideckAppId === undefined) {
            throw new Error('Required parameter xApideckAppId was null or undefined when calling leadsAll.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Leads;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "Leads");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param xApideckServiceId Provide the service id you want to call (e.g., pipedrive). See the full list in the connector section. Only needed when a consumer has activated multiple integrations for a Unified API.
     */
    public async leadsDelete (xApideckConsumerId: string, xApideckAppId: string, id: string, raw?: boolean, xApideckServiceId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: LeadsDeleteResponse;  }> {
        ...
        // verify required parameter 'xApideckConsumerId' is not null or undefined
        if (xApideckConsumerId === null || xApideckConsumerId === undefined) {
            throw new Error('Required parameter xApideckConsumerId was null or undefined when calling leadsDelete.');
        }

        // verify required parameter 'xApideckAppId' is not null or undefined
        if (xApideckAppId === null || xApideckAppId === undefined) {
            throw new Error('Required parameter xApideckAppId was null or undefined when calling leadsDelete.');
        }

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling leadsDelete.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: LeadsDeleteResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "LeadsDeleteResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param xApideckServiceId Provide the service id you want to call (e.g., pipedrive). See the full list in the connector section. Only needed when a consumer has activated multiple integrations for a Unified API.
     */
    public async leadsOne (xApideckConsumerId: string, xApideckAppId: string, id: string, raw?: boolean, xApideckServiceId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: Lead;  }> {
        const localVarPath = this.basePath + '/leads/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'xApideckConsumerId' is not null or undefined
        if (xApideckConsumerId === null || xApideckConsumerId === undefined) {
            throw new Error('Required parameter xApideckConsumerId was null or undefined when calling leadsOne.');
        }

        // verify required parameter 'xApideckAppId' is not null or undefined
        if (xApideckAppId === null || xApideckAppId === undefined) {
            throw new Error('Required parameter xApideckAppId was null or undefined when calling leadsOne.');
        }

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling leadsOne.');
        }
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: Lead;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "Lead");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
     ...
     * @param xApideckServiceId Provide the service id you want to call (e.g., pipedrive). See the full list in the connector section. Only needed when a consumer has activated multiple integrations for a Unified API.
     */
    public async leadsUpdate (xApideckConsumerId: string, xApideckAppId: string, id: string, leadsUpdate: LeadsUpdate, raw?: boolean, xApideckServiceId?: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: LeadsUpdateResponse;  }> {
        const localVarPath = this.basePath + '/leads/{id}'
            .replace('{' + 'id' + '}', encodeURIComponent(String(id)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
        ...
        // verify required parameter 'xApideckConsumerId' is not null or undefined
        if (xApideckConsumerId === null || xApideckConsumerId === undefined) {
            throw new Error('Required parameter xApideckConsumerId was null or undefined when calling leadsUpdate.');
        }

        // verify required parameter 'xApideckAppId' is not null or undefined
        if (xApideckAppId === null || xApideckAppId === undefined) {
            throw new Error('Required parameter xApideckAppId was null or undefined when calling leadsUpdate.');
        }

        // verify required parameter 'id' is not null or undefined
        if (id === null || id === undefined) {
            throw new Error('Required parameter id was null or undefined when calling leadsUpdate.');
        }

        // verify required parameter 'leadsUpdate' is not null or undefined
        if (leadsUpdate === null || leadsUpdate === undefined) {
            throw new Error('Required parameter leadsUpdate was null or undefined when calling leadsUpdate.');
        }
        ...
        let localVarRequestOptions: localVarRequest.Options = {
            ...
            useQuerystring: this._useQuerystring,
            json: true,
            body: ObjectSerializer.serialize(leadsUpdate, "LeadsUpdate")
        };
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: LeadsUpdateResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        body = ObjectSerializer.deserialize(body, "LeadsUpdateResponse");
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            resolve({ response: response, body: body });
                        } else {
                            reject(new HttpError(response, body, response.statusCode));
