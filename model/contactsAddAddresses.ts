...
export class ContactsAddAddresses {
    'id'?: string;
    'type'?: ContactsAddAddresses.TypeEnum;
    'name'?: string | null;
    /**
    ...
    */
    ...
    static getAttributeTypeMap() {
        return ContactsAddAddresses.attributeTypeMap;
    }
}
...
export namespace ContactsAddAddresses {
    export enum TypeEnum {
        ...
        Invoicing = <any> 'invoicing',
        Delivery = <any> 'delivery',
        Visiting = <any> 'visiting',
        Mailing = <any> 'mailing',
        Home = <any> 'home',
        Work = <any> 'work',
        Other = <any> 'other'
