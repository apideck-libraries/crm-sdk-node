...
export class OpportunityData {
    ...
    'dateStageChanged'?: Date | null;
    'dateLastContacted'?: Date | null;
    'dateLeadCreated'?: Date | null;
    ...
    static attributeTypeMap: Array<{name: string, baseName: string, type: string}> = [
        ...
        {
            "name": "dateStageChanged",
            "baseName": "date_stage_changed",
            "type": "Date"
        },
        {
            "name": "dateLastContacted",
            "baseName": "date_last_contacted",
            "type": "Date"
        },
        {
            "name": "dateLeadCreated",
            "baseName": "date_lead_created",
            "type": "Date"
        },
        {
            "name": "updatedBy",
    ...
    static getAttributeTypeMap() {
        return OpportunityData.attributeTypeMap;
    }
}
